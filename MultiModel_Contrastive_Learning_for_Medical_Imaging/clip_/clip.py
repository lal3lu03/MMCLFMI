...
from clip_.model import build_model
from clip_.tokenizer import SimpleTokenizer as _Tokenizer
...
def load(name: str, device: Union[str, torch.device] = "cuda" if torch.cuda.is_available() else "cpu", device_ids: List[int] = None, jit=True, is_train=False, pretrained=True):
    """Load a CLIP model
    Parameters
    ----------
    name : str
